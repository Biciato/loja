    ...
    respond_to do |format|
      if @usuario.save
        format.html { redirect_to usuarios_url,
          notice: "Usuário #{@usuario.nome} foi criado com sucesso" }
  ...
  def update
    respond_to do |format|
      if @usuario.update(usuario_params)
        format.html { redirect_to usuarios_url,
          notice: "Usuario #{@usuario.nome} foi atualizado com sucesso." }
...
rescue_from 'Usuario::Error' do |exception|
  ...
  private
    ...
    def usuario_params
      params.require(:usuario).permit(:nome, :password, :password_confirmation)
    end
end
